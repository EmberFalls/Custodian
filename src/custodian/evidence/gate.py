...
from custodian.core.enums import AlertDecision, EvidenceQuality
from custodian.core.schemas import CapabilityProfile, DetectorVerdict
...
class EvidenceGate:
    ...
    def evaluate(
        ...
        if verdict.threat_class.value in {"BOT_OR_C2_LIKE", "SUSPICIOUS_ENCRYPTED"}:
